...
JSONWebKeySet = {
        Remote = {                                   # cannot specify with JWKS{}.Local
          ...
          JWKSCluster = {
            ...
            ConnectTimeout = "10s"
            TLSCertificates = {
              TrustedCA = {                                # cannot specify with JWKSCluster{}.CaCertificateProviderInstance
                Filename = "<path/to/cert/file>"           # cannot specify with JWKSCluster{}.TrustedCA.EnvironmentVariable, JWKSCluster{}.TrustedCA.InlineString or JWKSCluster{}.TrustedCA.InlineBytes
                EnvironmentVariable = "<env-variable>"     # cannot specify with JWKSCluster{}.TrustedCA.Filename, JWKSCluster{}.TrustedCA.InlineString or JWKSCluster{}.TrustedCA.InlineBytes
                InlineString = "<inline-string>"           # cannot specify with JWKSCluster{}.TrustedCA.Filename, JWKSCluster{}.TrustedCA.EnvironmentVariable or JWKSCluster{}.TrustedCA.InlineBytes
                InlineBytes = "\302\000\302\302\302\302"   # cannot specify with JWKSCluster{}.TrustedCA.Filename, JWKSCluster{}.TrustedCA.InlineString or JWKSCluster{}.TrustedCA.EnvironmentVariable
              }
            }
            TLSCertificates = {
              CaCertificateProviderInstance = {      # cannot specify with JWKSCluster{}.TrustedCA
  ...
  jsonWebKeySet:
    remote:                                       # cannot specify with spec.jsonWebKeySet.local
      ...
      jwksCluster:
        ...
        connectTimeout: 10s
        tlsCertificates:
          trustedCA:                                # cannot specify with spec.jwksCluster.caCertificateProviderInstance
            filename: <path/to/cert/file>           # cannot specify with spec.jwksCluster.trustedCA.environmentVariable, spec.jwksCluster.trustedCA.inlineString or spec.jwksCluster.trustedCA.inlineBytes
            environmentVariable: <env-variable>     # cannot specify with spec.jwksCluster.trustedCA.filename, spec.jwksCluster.trustedCA.inlineString or spec.jwksCluster.trustedCA.inlineBytes
            inlineString: <inline-string>           # cannot specify with spec.jwksCluster.trustedCA.filename, spec.jwksCluster.trustedCA.environmentVariable or spec.jwksCluster.trustedCA.inlineBytes
            inlineBytes: \302\000\302\302\302\302   # cannot specify with spec.jwksCluster.trustedCA.filename, spec.jwksCluster.trustedCA.inlineString or spec.jwksCluster.trustedCA.environmentVariable
        tlsCertificates:
          caCertificateProviderInstance:            # cannot specify with spec.jwksCluster.trustedCA
            instanceName: <instance-name>
            certificateName: <certificate-name>
  audiences: [<aud-claims>]
  locations: 
...
| `EnvironmentVariable` | Environment variable data source.      | String    | None          |
| `InlineString` | String inlined in the configuration.          | String    | None          |
| `InlineBytes` | Bytes inlined in the configuration.            | String    | None          |
